...
(function() {
  ...
  const QuestionCopy = {
    ...
    extractQuestionContent: function() {
    ...
    extractRightPanelQuestion: function() {
    ...
    extractTextWithMath: function(element) {
    ...
    extractMathText: function(mathElement) {
      let result = '';
  ...
  window['APToolkit_question-copy'] = QuestionCopy;
  QuestionCopy.init();
})();
